...
class OTPVerificationPageMobile extends StatefulWidget {
  final String email;
  const OTPVerificationPageMobile({Key? key, required this.email}) : super(key: key);

  @override
  _OTPVerificationPageMobileState createState() => _OTPVerificationPageMobileState();
}

class _OTPVerificationPageMobileState extends State<OTPVerificationPageMobile> {
