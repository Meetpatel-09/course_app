...
class AddProject extends StatefulWidget {
  ...
  final String? name;
  const AddProject({Key? key, required this.email, required this.password, required this.isGoogle, this.name}) : super(key: key);
  ...
  Widget formFields() {
    return Column(
      children: [
        ...
        const SizedBox(height: 15,),
        Align(child: "Project Profile Picture".text.lg.center.make()),
        const SizedBox(height: 30,),
