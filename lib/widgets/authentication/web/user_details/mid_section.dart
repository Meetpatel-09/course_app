...
class MidSectionUserDetails extends StatefulWidget {
  const MidSectionUserDetails({Key? key}) : super(key: key);

  @override
  _MidSectionUserDetailsState createState() => _MidSectionUserDetailsState();
}

class _MidSectionUserDetailsState extends State<MidSectionUserDetails> {
